...
describe("CappedRevenueShareFactory", function() {
  ...
  it("won't create a CappedRevenueShare contract without being initialized", async function() {
    try {
      await this.cappedRevenueShareFactory.createNewCappedRevenueShare(
        this.validInput,
  ...
  it("can create a CappedRevenueShare contract and initialize it", async function() {
    ...
    let deployedAddress = await this.cappedRevenueShareFactory.createNewCappedRevenueShare(
      this.validInput,
      ethers.constants.AddressZero,
      false,
      true
  ...
  it("can create a CappedRevenueShare contract and reconfigure it", async function() {
    ...
    await deployedClone.reconfigureCappedSplits(
      this.validSplitTuple.cappedSplits
    );
...
const getLogs = async (address: string) => {
  let cappedRevShareFactoryABI = require(path.resolve(
    __dirname,
    "../../abi/contracts/CappedRevenueShare/CappedRevenueShareFactory.sol/CappedRevenueShareFactory.json"
  ));
